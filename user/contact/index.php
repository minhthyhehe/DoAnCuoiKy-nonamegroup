...
<head>
  ...
  <link rel="stylesheet" href="../assets/plugins/owl.carousel/owl.theme.default.min.css" type="text/css">
...
<body>
  <!-- <div class="header">
    <a style="color: #ffffff;text-decoration: none;" href="../index.html">MIỄN PHÍ VẬN CHUYỂN VỚI ĐƠN HÀNG NỘI THÀNH >
      300K
          ...
          <div class="box-info-contact">
            <ul class="list-info">
              <li>
                ...
                <p><strong>232/6 đường Võ Thị Sáu, phường 7, quận 12, Tp. Hồ
                    Chí Minh.</strong></p>
              </li>
              <li>
                <p>Email chúng tôi</p>
                <p><strong>abctest123@aziworld.com</strong></p>
              </li>
              <li>
                <p>Điện thoại</p>
