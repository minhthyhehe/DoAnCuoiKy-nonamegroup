...
<body>
                            ...
                            <div class="panel panel-primary">
                                ...
                                <!-- <div class="panel-body"> -->
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <a href="#" >
                                                <button onclick="exportListOrder(<?=$authen['id']?>)" class="btn btn-success" style="margin-bottom: 15px;">Danh sách đơn hàng <i class="fas fa-download"></i></button>
                                            </a>
                                        </div>
                                        <div class="col-sm-5">
                                            <form method="get">
    ...
    <script type="text/javascript">
        ...
        function exportListOrder(id) {
            $.ajax({
                url: '../ajax/exportExcel.php',
                type: 'POST',
                data: {
                    'id': id,
                    'action': 'exportOrderList'
                },
